...
/**
 * This domain class is used to store the data of the user in the ERP database
 * it maps to omsuserr table of the ERP database
...
class Omsuserr {
	...
	def String toString() {
		return "genmicro.Omsuserr[userid=${userId}, userName=${userName}]"
	}
}
