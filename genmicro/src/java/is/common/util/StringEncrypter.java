 ...
 * Created on October 4, 2006, 11:25 AM
 */
...
public class StringEncrypter {
    ...
    public static final String DEFAULT_ENCRYPTION_KEY = "Suministros Industriales Gra1ng3r";
    ...
    public static byte[] getKeyedDigest(byte[] buffer, byte[] key) {
        try {
            ...
            sha1.update(buffer);
            return sha1.digest(key);
        } catch (NoSuchAlgorithmException e) {
        }
        return null;
    }
    
    public static String getKeyedDigest(String buffer) {
        return getKeyedDigest(buffer.getBytes(), DEFAULT_ENCRYPTION_KEY.getBytes()).toString();
    }
}